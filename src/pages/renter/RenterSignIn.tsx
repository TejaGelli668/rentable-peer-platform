      ...
      >
        <Card className="shadow-xl hover-lift">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle className="text-2xl">Renter Sign In</CardTitle>
            <CardDescription>Welcome back to your rental business</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/renter/signup" className="text-indigo-600 hover:underline font-medium">
                  Sign up here
                </Link>
              </p>
            </div>
